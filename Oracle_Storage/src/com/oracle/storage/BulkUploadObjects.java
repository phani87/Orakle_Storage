...
public class BulkUploadObjects {
	...
	public String bulkUploadObjectImpl(String cloud_container_name, InputStream cloud_input_stream, String fileName) {
	...
	public static void main(String[] args) throws IOException {
		BulkUploadObjects blk = new BulkUploadObjects();
